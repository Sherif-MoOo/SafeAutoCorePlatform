...
# File description:
# -----------------
# CMake initial-cache file for clang 21 on Linux aarch64 (Release configuration).
...
#[=======================================================================[
.rst:
clang21_linux_aarch64_release
----------------------------
CMake initial cache file for clang 21 on Linux aarch64 (Release build).

All variables can be set as initial cache variables and passed as a file to CMake:

.. code-block:: cmake

    # Create an initial cache file (clang21_linux_aarch64_release.cmake) and define in there:
    set(CMAKE_PREFIX_PATH "/usr/local/clang-21" CACHE STRING "")
    set(CMAKE_TOOLCHAIN_FILE "/path/to/toolchain/clang21_linux_aarch64.cmake" CACHE PATH "")

.. code-block:: shell-session

    $ cmake -C CMake/CMakeConfig/clang21_linux_aarch64_release.cmake -S <project-root> -B <build-dir>
...
message(STATUS "Using clang21_linux_aarch64_release.cmake for initial cache setup.")
