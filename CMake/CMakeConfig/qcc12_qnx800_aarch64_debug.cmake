...
#[=======================================================================[
.rst:
QNX80_AARCH64_QCC12_MAXIMUM_SAFETY_DEBUG
-----------------------------------------
Maximum safety and security configuration for QNX 8.0 aarch64 using QCC-12 (GCC 12.2.0)
...
.. code-block:: bash
    ...
    cmake -C qcc12_qnx80_aarch64_debug.cmake \
...
#   • Safety: All variables initialized to 0xAA pattern
#   • Debug: Uninitialized use obvious (not zero)
#   • Example: int x; // Contains 0xAAAAAAAA
...
# -mbranch-protection=standard: Full PAC+BTI
#   • PAC: Pointer Authentication Codes
#   • BTI: Branch Target Identification  
#   • Prevents: ROP/JOP attacks
#   • Hardware: Uses ARMv8.3 features
...
string(APPEND OPENAA_CXX_FLAGS " -fconcepts-diagnostics-depth=5")
...
#
# -fconcepts-diagnostics-depth=5: Concept errors
