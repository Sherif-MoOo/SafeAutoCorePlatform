...
# File description:
# -----------------
# CMake initial-cache file for clang 21 on Linux x86_64.
...
.. code-block:: cmake
    ...
    # Create an initial cache file (clang21_linux_x86_64.cmake) and define in there:
    set(CMAKE_PREFIX_PATH "/usr/local/clang-21" CACHE STRING "")
    set(CMAKE_TOOLCHAIN_FILE "/path/to/toolchain/clang21_linux_x86_64.cmake" CACHE PATH "")

.. code-block:: shell-session

    $ cmake -C CMake/CMakeConfig/clang21_linux_x86_64.cmake -S <project-root> -B <build-dir>
...
#=======================================================================
message(STATUS "Using clang21_linux_x86_64_release.cmake for initial cache setup.")
...
#=======================================================================
#
# AUTOSAR provides specific guidelines and macros. Depending on the clang
