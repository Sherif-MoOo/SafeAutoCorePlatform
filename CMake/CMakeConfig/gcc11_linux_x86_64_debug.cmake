...
# File description:
# -----------------
# CMake initial-cache file for GCC 11 on Linux x86_64 (Debug configuration).
...
#[=======================================================================[ 
.rst:
gcc11_linux_x86_64_debug
------------------------
CMake initial cache file for GCC 11 on Linux x86_64 Debug build.

All variables can be set as initial cache variables and passed as a file to CMake:

.. code-block:: cmake

    # Create an initial cache file (gcc11_linux_x86_64_debug.cmake) and define in there:
    set(CMAKE_PREFIX_PATH "/usr/local/gcc-11" CACHE STRING "")
    set(CMAKE_TOOLCHAIN_FILE "/path/to/toolchain/gcc11_linux_x86_64_debug.cmake" CACHE PATH "")

.. code-block:: shell-session

    $ cmake -C CMake/CMakeConfig/gcc11_linux_x86_64_debug.cmake -S <project-root> -B <build-dir>
