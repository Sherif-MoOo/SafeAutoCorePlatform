...
# File description:
# -----------------
# CMake initial-cache file for GCC 13 on Linux x86_64.
...
.. code-block:: cmake
    ...
    # Create an initial cache file (gcc13_linux_x86_64.cmake) and define in there:
    set(CMAKE_PREFIX_PATH "/usr/local/gcc-13" CACHE STRING "")
    set(CMAKE_TOOLCHAIN_FILE "/path/to/toolchain/gcc13_linux_x86_64.cmake" CACHE PATH "")

.. code-block:: shell-session

    $ cmake -C CMake/CMakeConfig/gcc13_linux_x86_64.cmake -S <project-root> -B <build-dir>
...
#=======================================================================
message(STATUS "Using gcc13_linux_x86_64_release.cmake for initial cache setup.")
